...
function initializeForm(beneficiary: Beneficiary) {
    Object.assign(formValues, {
        nik: beneficiary.nik,
        place_of_birth: beneficiary.place_of_birth || '',
        date_of_birth: useDateFormat(beneficiary.date_of_birth, 'YYYY-MM-DD').value || '',
        name: beneficiary.name,
        neighborhood_unit: beneficiary.neighborhood_unit || '',
        gender: beneficiary.gender || '',
        last_education: beneficiary.last_education || '',
        school_grade: beneficiary.school_grade || '',
        shirt_size: beneficiary.shirt_size || '',
        shoe_size: beneficiary.shoe_size || '',
        father: beneficiary.father || '',
        mother: beneficiary.mother || '',
        father_death_certificate_number: beneficiary.father_death_certificate_number || '',
        mother_death_certificate_number: beneficiary.mother_death_certificate_number || '',
...
<template>
    ...
    <Head>
        <title>Ubah Penerima Manfaat</title>
    </Head>

    <DashboardLayout>
        <template #header>
            <h1 class="text-xl font-semibold tracking-tight">Ubah Penerima Manfaat</h1>
        </template>
