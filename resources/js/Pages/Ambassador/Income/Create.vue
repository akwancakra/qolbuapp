...
async function onSubmit(values: any) {
    ...
    try {
        ...
        Inertia.post(route('ambassador.incomes.store'), {
            ...values,
...
<template>
    ...
    <GuestLayout :containerClass="'sm:max-w-xl'">
        <Link :href="route('ambassador.incomes.index')">
        <Button class="space-x-1 mb-3" type="button" variant="outline" :disabled="isSubmitting">
            <CornerUpLeftIcon class="w-4 h-4" /> Kembali
        </Button>
        </Link>

        <Card
            className="mx-auto bg-white rounded-md border border-neutral-300 px-3 py-2 sm:px-6 sm:py-4 dark:border-neutral-600 dark:bg-neutral-800">
            <CardHeader>
